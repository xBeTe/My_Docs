...
> Hyperledger Explorer 是一个简单、强大、易于使用、维护良好的开源工具，可以浏览底层区块链网络上的活动。 项目地址：[https://github.com/hyperledger/blockchain-explorer](https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fgithub.com%2Fhyperledger%2Fblockchain-explorer)
...
```json
{
    "network-configs": {
        "prod-network": {
            "name": "Prod Network",
            "profile": "./connection-profile/prodNetworkConnection.json"
        }
    },
    "license": "Apache-2.0"
}
...
services:
    ...
    explorer.mynetwork.com:
        ...
        ports:
            - 9090:8080
        extra_hosts:
            - "explorerdb.mynetwork.com:192.168.159.10"
...
![image-20240108213136570](http://mydoc-pics.oss-cn-chengdu.aliyuncs.com/img/image-20240108213136570.png)